...
| Model                                                 | Max Rel Err (%) | Mean Rel Err (%) |
+=======================================================+=================+==================+
| MH (Di=0.8, bi=1.8) + PLYield (c=1.2, m=0.6)          |      1.0e-04    |       2.1e-05    |
+-------------------------------------------------------+-----------------+------------------+
| MH (Di=0.5, bi=1.2) + PLYield (c=0.8, m=0.3)          |      4.9e-05    |       1.3e-05    |
+-------------------------------------------------------+-----------------+------------------+
| MH (Di=0.9, bi=2.0) + PLYield (c=0.5, m=0.8)          |      1.4e-04    |       4.0e-05    |
+-------------------------------------------------------+-----------------+------------------+
